...
const formSchema = z.object({
  ...
  requestedAmount: z.coerce
    .number()
    .min(100, "Minimum grant request is $100")
    .max(25000, "Maximum grant request is $25,000"),
  ...
  description: z
    ...
    .min(
      20,
      "Please provide more details about your situation (min 20 characters)",
    ),
...
export default function Apply() {
      ...
      { data },
      {
        onSuccess: (response) => {
          setSubmittedApplicationId(
            (response as { applicationId?: string | null }).applicationId ??
              null,
          );
  ...
  if (
    ...
    (submitApp.isSuccess && !submitApp.isPending)
  ) {
      ...
      <div className="min-h-[80dvh] flex items-center justify-center bg-muted/30 py-20 px-4">
        ...
        >
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-2xl p-6 mb-8">
            <p className="text-sm text-muted-foreground uppercase tracking-widest mb-2 font-semibold">
              Your Application ID
            </p>
            ...
            <p className="text-sm text-muted-foreground mt-2">
              Please save this for your records. A confirmation email has been
              sent to you — check your inbox, and if you don't see it within a
              few minutes, please check your spam or junk folder.
            </p>
          </div>

          <p className="text-base text-muted-foreground mb-10 leading-relaxed">
            Our review team will evaluate your submission and contact you with
            updates within <strong>1–2 business days</strong>.
          </p>
          <Button
            size="lg"
            onClick={() => setLocation("/")}
      ...
      <div className="bg-primary text-primary-foreground pt-20 pb-32 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          ...
          <p className="text-lg text-primary-foreground/80 max-w-2xl mx-auto">
            All information you provide is strictly confidential and used only
            by our academic review committee to assess your eligibility for
            ...
            >
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="123 Campus Drive, Apt 2B, City, State, ZIP"
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="e.g. University of Michigan, Ann Arbor"
                              {...field}
                            />
                          </FormControl>
                          <FormDescription>
                            Enter the full name of your enrolled institution.
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        >
                          ...
                          <SelectContent>
                            {Object.entries(yearOfStudyLabels).map(
                              ([value, label]) => (
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        >
                          ...
                          <SelectContent>
                            {Object.entries(grantTypeLabels).map(
                              ([value, label]) => (
                                <SelectItem key={value} value={value}>
                                  {label}
                                </SelectItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Maximum grant: $25,000 per application.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Helps our committee assess financial need.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        A clear, honest statement helps your application stand
                        out.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm mb-6">
                  If your application is approved, how would you like to receive
                  your grant funds?
                </p>
                <FormField
                  control={form.control}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-2">
                        {Object.entries(paymentMethodLabels).map(
                          ([value, { label, desc }]) => (
                            ...
                            >
                              <div
                                className={`font-bold text-base mb-1 ${field.value === value ? "text-primary" : "text-foreground"}`}
                              >
                                {field.value === value && (
              ...
              <div className="pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
                <p className="text-sm text-muted-foreground">
                  ...
                  accurate and you agree to our Terms of Service.
                </p>
                <Button
                  type="submit"
                  size="lg"
